...
DAC_MemMapPtr DACN[DAC_MAX] = {DAC0_BASE_PTR}; //定义两个指针数组保存 DACN 的地址
 ...
 *  @param      DACn_e      DAC模块号
 *  @since      v5.0
 *  Sample usage:       dac_init (DAC0 );    //初始化 DAC0
 */
 ...
 *  @since      v5.0
 *  Sample usage:       dac_out (DAC0 ,0x100);    //初始化 DAC0 输出 0x100 数字量对应的模拟量
 */
