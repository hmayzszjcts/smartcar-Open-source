...
extern uint8   P_1, P_2;
extern uint16  P_3, D_1;
extern uint32  D_2, D_3;

uint32 *var_addr[VAR_MAX] = {(uint32 *)&car_ctrl,(uint32 *)& P_1, (uint32 *)& P_2, (uint32 *)& P_3, (uint32 *)& D_1, (uint32 *)& D_2, (uint32 *)& D_3};
